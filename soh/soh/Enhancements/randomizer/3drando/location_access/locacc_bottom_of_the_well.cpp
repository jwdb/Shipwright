...
void AreaTable_Init_BottomOfTheWell() {
  ...
  areaTable[RR_BOTTOM_OF_THE_WELL_MAIN_AREA] = Area("Bottom of the Well Main Area", "Bottom of the Well", RA_BOTTOM_OF_THE_WELL, NO_DAY_NIGHT_CYCLE, {
                  ...
                  LocationAccess(RC_BOTTOM_OF_THE_WELL_FIRE_KEESE_POT_1,             {[]{return logic->CanBreakPots && (randoCtx->GetTrickOption(RT_LENS_BOTW) || logic->CanUse(RG_LENS_OF_TRUTH)) && logic->SmallKeys(RR_BOTTOM_OF_THE_WELL, 3);}}),    
                  LocationAccess(RC_BOTTOM_OF_THE_WELL_UNDERWATER_POT,               {[]{return logic->CanBreakPots && (logic->CanUse(RG_ZELDAS_LULLABY) || logic->Boomerang || logic->Slingshot);}}),      
                }, {
                  //Exits
